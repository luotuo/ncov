...
export const provinceList = {
  ...
  list: [
    ...
    {
      name: '河北',
      url: 'http://www.hebwst.gov.cn/index.do?templet=new_list&cid=14'
    },
    {
      name: '山西',
      url: 'http://wjw.shanxi.gov.cn/xwzxl02/index.hrh'
    },
    {
      name: '内蒙古',
    ...
    {
      name: '黑龙江',
      url: 'http://wsjkw.hlj.gov.cn/index.php/Home/Zwgk/all/typeid/42'
    },
    {
      name: '上海',
    ...
    {
      name: '浙江',
      url: 'http://www.zjwjw.gov.cn/col/col1202194/index.html'
    },
    {
      name: '安徽',
    ...
    {
      name: '山东',
      url: 'http://wsjkw.shandong.gov.cn/wzxxgk/zwgg/'
    },
    {
      name: '河南',
    ...
    {
      name: '湖南',
      url: 'http://wjw.hunan.gov.cn/wjw/xxgk/gzdt/zyxw_1/index.html'
    },
    {
      name: '广东',
    ...
    {
      name: '海南',
      url: 'http://wst.hainan.gov.cn/yqfk/'
    },
    {
      name: '重庆',
    ...
    {
      name: '贵州',
      url: 'http://www.gzhfpc.gov.cn/ztzl_500663/xxgzbdgrdfyyqfk/yqdt/'
    },
    {
      name: '云南',
    ...
    {
      name: '陕西',
      url: 'http://sxwjw.shaanxi.gov.cn/col/col863/index.html'
    },
    {
      name: '甘肃',
      url: 'http://wsjk.gansu.gov.cn/channel/11218/index.html'
    },
    {
      name: '青海',
    ...
    {
      name: '宁夏',
      url: 'http://wsjkw.nx.gov.cn/yqfkdt/yqsd1.htm'
    },
    {
      name: '新疆',
